...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      {/* Navigation */}
      <nav className="fixed top-0 z-50 w-full border-b bg-white/80 backdrop-blur-xl dark:border-neutral-800 dark:bg-neutral-950/80">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg border-2 dark:border-neutral-700">
            ...
            {[
              ...
              >
                <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                  <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl border-2 bg-white dark:bg-neutral-900 dark:border-neutral-800">
          ...
          <div className="space-y-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="rounded-xl border-2 bg-white p-6 shadow-sm hover:shadow-md transition-shadow dark:bg-neutral-900 dark:border-neutral-800"
              >
      ...
      {/* Footer */}
      <footer className="border-t py-12 px-6 bg-white dark:bg-neutral-950 dark:border-neutral-800">
        <div className="mx-auto max-w-7xl">
