    ...
    <>
      ...
      <div className="flex flex-1 flex-col gap-6 overflow-y-auto px-5 py-6">
        <section className="rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-4">
          <h2 className="text-sm font-semibold text-neutral-900">Model routing</h2>
        ...
        <section className="rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-4">
          <h2 className="text-sm font-semibold text-neutral-900">AWS integrations</h2>
          <p className="mt-2 text-xs text-neutral-600">
        ...
        <section className="rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-4">
          <h2 className="text-sm font-semibold text-neutral-900">Playback & sharing</h2>
          <p className="mt-2 text-xs text-neutral-600">
